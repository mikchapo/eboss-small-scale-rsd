...
int main (void){
  ...
  //////////         WEIGHT COUNTS         //////////
  ///////////////////////////////////////////////////
  double DD_norm_par = ((double)(cntg)*(double)(cntg-1))/2.;
  double DD_norm_fib = 0.;
  int i;
...
#pragma omp atomic
  ...
  cout<<"DD_norm_par: "<<DD_norm_par<<endl<<"DD_norm_fib: "<<DD_norm_fib<<endl;    
  ...
  pfw<<"DD_norm_par\tDD_norm_fib"<<endl<<setprecision(6)<<fixed<<DD_norm_par<<"\t"<<DD_norm_fib;
  pfw.close();
